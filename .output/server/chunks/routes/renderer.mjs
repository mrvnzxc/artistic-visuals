...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Artistic Visuals photography portfolio and services. Professional portraits, events, weddings, and more."}],"link":[],"style":[],"script":[],"noscript":[],"title":"Artistic Visuals | Photography"};
