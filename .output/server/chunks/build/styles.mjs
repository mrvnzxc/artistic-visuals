...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.z-gzRRho.mjs').then(interopDefault),
  "app.vue": () => import('./app-styles.BvtLAWbH.mjs').then(interopDefault),
  "pages/contact.vue": () => import('./contact-styles.jeM2XFr0.mjs').then(interopDefault),
  "app.vue?vue&type=style&index=0&lang.css": () => import('./app-styles.BvtLAWbH.mjs').then(interopDefault),
  "pages/contact.vue?vue&type=style&index=0&lang.css": () => import('./contact-styles.jeM2XFr0.mjs').then(interopDefault),
